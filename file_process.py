...
def get_gpt_response(extracted_text):
    ...
    try:
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "user", "content": "Extract Store name:, Date:, Item Purchase:  and its corresponding Price on separate lines. Ensure each item is on a new line without extra punctuation or symbols.Some receipt just show  Item Purchase or Price with labeling the column"},
