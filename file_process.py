...
def get_gpt_response(extracted_text):
    ...
    try:
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "user", "content": "Extract and display ONLY the Store Name : , followed by each Item Purchase:  and its corresponding Price on separate lines. Ensure each item is on a new line without extra punctuation or symbols."},
